...
from eshop import app, db, bcrypt
from eshop.forms import RegistrationForm, LoginForm, UpdateAccountForm
from eshop.models import User, Products, Cart
...
@app.route("/Eshop-project")
def Eshop_project():
    noOfItems = getLoginDetails()
    return render_template("Eshop-project.html", title='The project', noOfItems=noOfItems)
